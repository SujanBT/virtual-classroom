...
from .views.room import ViewClassRoom,SingleClass,CreateClassRoom,JoinRoom, LeaveClass, SendMail,meeting
...
urlpatterns =[
    ...
    path('dashboard/',meeting.dashboard,name='dashboard'),
    path('meeting/', meeting.videocall,name='meeting'),
    # path('logout/', meeting.logout_view,name='logout'),
    path('join/', meeting.join_room,name='join'),
